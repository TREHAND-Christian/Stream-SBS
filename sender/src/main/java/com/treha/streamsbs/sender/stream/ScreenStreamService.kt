...
import com.treha.streamsbs.sender.MainActivity
import com.treha.streamsbs.sender.R
import com.treha.streamsbs.sender.StreamConfig
import com.treha.streamsbs.sender.network.ReceiverRenderStatusListener
...
class ScreenStreamService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_START = "com.treha.streamsbs.sender.START_STREAM"
        private const val ACTION_UPDATE_PROFILE = "com.treha.streamsbs.sender.UPDATE_PROFILE"
